...
- `release/iptv-client.v<版本号>.apk`（当前为 `iptv-client.v1.0.10.apk`）
- 开发服务器也可下载： [http://127.0.0.1:43217/iptv-client.v1.0.10.apk](http://127.0.0.1:43217/iptv-client.v1.0.10.apk)
...
1. 把 `iptv-client.v1.0.10.apk` 发到手机（微信/网盘/数据线）。
2. 打开文件，允许「安装未知应用」。
